                        ...
                        <div className="col-lg-6 justify-content-center px-5">
                            <div className="row justify-content-center">
                                ...
                                <ul className="pl-0 px-5">
                                    ...
                                    <li className="d-flex">
                                        <i
                                            className="ri-phone-line mr-1 align-self-center pt-2"
                                            style={{fontSize: "1.6rem", color: "#0057b8"}}></i>
                                    ...
                                    <li className="d-flex mb-40">
                                        <i
                                            className="ri-mail-line mr-1 align-self-center pt-2"
                                            style={{fontSize: "1.6rem", color: "#0057b8"}}></i>
                                    ...
                                    <li className="d-flex mb-30">
                                        <i
                                            className="ri-map-pin-line mr-1 align-self-center pt-2"
                                            style={{fontSize: "1.6rem", color: "#0057b8"}}></i>
