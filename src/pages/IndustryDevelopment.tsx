...
import icon2Image from "../images/industry/ICON2.png"
import icon3Image from "../images/industry/ICON3.png"
import icon4Image from "../images/industry/ICON4.png"
import icon5Image from "../images/industry/ICON5.png"
import icon6Image from "../images/industry/ICON6.png"
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-8">
                                    ...
                                    <p>
                                        ...
                                        FOF以降低投资门槛。第一只证券类FOF由先锋基金(Vanguard)于1985年推出，该只共同基金FOF70%的资产投资于股票类基金，30%投资于债权类基金，投资标的均为公司旗下的基金。基金推出后大受欢迎，同时也带动了先锋基金旗下其他基金的销售，1986年末，先锋公司旗下基金规模增长44.23%。
                                    </p>
                                    <p>
...
function IndustryDevelopment() {
    return (
        <Suspense fallback="loading...">
            <IndustryDevComponent></IndustryDevComponent>
        </Suspense>
    )
}
