    ...
    return (
        <>
            <Helmet>
                ...
                <meta
                    name="description"
                    content="欢迎来到Carrick Just Asset Management Limited（凯利资产管理有限公司），我们旨在帮助您实现您的投资目标与财富梦想。凯利资产管理将为全球资产配置、税务规划、资产增值等一系列与财富管理相关的不同需求提供专业的金融服务。"
                />
            </Helmet>
            <Layout>
                        ...
                        <div className="row">
                            <div className="col-lg-7 order-2 order-lg-1">
                                ...
                                <p>
                                    ...
                                    是一家被新西兰政府授权提供投资管理计划的基金公司，金融服务牌照编号是
                                    690391。公司总部位于新西兰最繁华的商业金融中心奥克兰，凭借着作为南半球经济金融中心的市场地位和地利优势，本公司旗下凝聚了一批高端复合型投资人才，涵盖金融投资、地产投资、产业投资、股权投资以及投融资并购等方面精英，人才结构充分体现了多元化的特点，团队成员来自世界上不同国家和地区，宽阔的投资视野充分展现了团队国际化的特征。公司理念和宗旨是在稳健安全的投资前提下，利用信息优势和前沿科技优势，为投资者提供长期稳定且高于行业基准的投资回报。在此目标导向下，公司投研团队和投资管理团队会积极探索创新型投资模式，并在投资实践中充分利用大数据和人工智能等技术手段，一方面不断打磨和完善传统投资模型，另一方面根据当今市场最新发展趋势的动态演化，及时调整投资策略和投资方向，充分挖掘潜在的组合型投资机会。公司提供的系列基金产品，可满足不同类型的投资者需求，无论您是稳健型，激进型还是混合型的投资风格都会在我们这里找到适合您的投资方案。公司也会根据特定项目和特定需求，不定期地为特定投资者打造个性化的专属投资基金产品。
                                </p>
                            </div>
